...
func NewServer(shortener service.URLShortener, port, serverURL string, metricsCollector metrics.Collector) *Server {
	...
	if metricsCollector != nil {
		middleware := NewMetricsMiddleware(metricsCollector)
		finalHandler = middleware.Middleware(mux)
	}
