...
type Config struct {
	Type        string `json:"type"`         // Type of generator (md5, base62_counter, base62_random, nanoid)
	Length      int    `json:"length"`       // Length of generated codes (where applicable)
...
const (
	TypeMD5Hash       = "md5"
	TypeBase62Counter = "base62_counter"
	TypeBase62Random  = "base62_random"
	TypeNanoID        = "nanoid"
)
